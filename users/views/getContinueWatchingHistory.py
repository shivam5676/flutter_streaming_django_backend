...
from streaming_app_backend.mongo_client import users_collection,continueWatching
...
@swagger_auto_schema(
    method="GET",
    operation_description="This API will give user watch history. We need to pass the token in the headers using the 'token' key.",
    manual_parameters=[
        openapi.Parameter(
...
@api_view(["GET"])
@csrf_exempt
def getUserWatchHistory(request):
